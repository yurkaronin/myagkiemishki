...
var path = {
    ...
    src: {
        ...
        images: "src/assets/images/**/*.{jpg,png,svg,gif,ico,webp,webmanifest,xml}",
        fonts: "src/assets/fonts/**/*.{svg,eot,woff,woff2}"
    },
    watch: {
        html: "src/**/*.html",
        js: "src/assets/javascript/**/*.js",
...
function js() {
    return src(path.src.js, {base: './src/assets/javascript/'})
        .pipe(plumber())
